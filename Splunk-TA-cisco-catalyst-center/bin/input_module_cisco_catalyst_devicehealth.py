...
def get_devices(catalyst):
    ...
    while do_request_next:
        try:
            device_response = catalyst.devices.get_device_list(limit=limit, offset=offset)
...
def collect_events(helper, ew):
    ...
    health_devices = get_device_health(catalyst, input_interval)
